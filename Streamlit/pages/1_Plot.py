...
def main():
    ...
    # else:
    #     fixed_file_path = "cc_processed.csv"  
    ...
    #works well but just have to change negative numbers
    #-----------------------------------------------------------------
    ...
    # this graph should work, but if not i can fix after its added to yours
